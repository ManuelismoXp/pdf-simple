...
exports.spacedTable = void 0;
const align_1 = require("../utils/align");
const spacedTable = (pdf, x, y, headers, headerheight, dataset, border = false) => {
    const widths = [];
    let newX = x;
    headers === null || headers === void 0 ? void 0 : headers.forEach(head => {
        ...
        (0, align_1.align)(pdf, newX + 1, y, head.text, head.width, (_b = head.align) !== null && _b !== void 0 ? _b : undefined);
        newX += head.width + 1;
    });
    dataset === null || dataset === void 0 ? void 0 : dataset.forEach((data, index) => {
        ...
        data === null || data === void 0 ? void 0 : data.forEach((element, i) => {
            ...
            (0, align_1.align)(pdf, newX + 1, y, element, widths[i].width, (_a = widths[i].align) !== null && _a !== void 0 ? _a : undefined);
            newX += widths[i].width + 1;
        });
    });
};
exports.spacedTable = spacedTable;
